...
namespace Locacao
{
    // Author: Lucas Gomes & João Vitor Pedral
            ...
            while (true)
            {
                ...
                switch (opcao)
                {
                    case '1':
                        ...
                        Console.WriteLine("Informe o nome do tipo de equipamento:");
                        ...
                        Console.WriteLine($"Tipo de equipamento {novoTipo.Nome} cadastrado com sucesso.");
                        break;
